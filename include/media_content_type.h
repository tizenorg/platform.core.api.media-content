...
typedef enum
{
    ...
    MEDIA_CONTENT_STORAGE_EXTERNAL_USB_STORAGE   = 2,    /**< The external storage of USB Storage (Since 2.4) */
    MEDIA_CONTENT_STORAGE_EXTERNAL_NETWORK_DEVICE   = 3,  /**< The external storage of Network Storage (Since 3.0) */
