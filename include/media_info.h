...
/**
 * @brief Starts face detection for the given media, asynchronously.
 * @details This function detects faces for given media item and calls the given callback function when the detection is completed. \n
 *          If faces have already been detected, then the given callback function will be invoked. \n
 *          If no face have not been detected for the given media, the number of faces will be 0 in the given callback function.
 *
 * @since_tizen 3.0
 *
 * @privlevel public
 ...
 *          If face detection is failed, the @a face_count argument in media_face_detection_completed_cb() will be set to 0.
 *          Items in external storage except MMC not supported.
 *
 * @param[in] media     The media info handle
 * @param[in] callback  The callback function to be invoked whe detection is completed
 * @param[in] user_data The user data to be passed to the callback function
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
