 ...
 *          And thumbnail is optional information. So if you want to see the thumbnail in your application, you have to use this API.
 *
 * @since_tizen @if MOBILE 2.3 @elseif WEARABLE 2.3.1 @endif
 *
 * @privlevel public
 ...
 *                   If returned thumbnail path in callback is empty string, the framework fails to create thumbnail.
 *
 * @param[in] media     The media info handle
 * @param[in] callback  The callback function to be invoked
 * @param[in] user_data The user data to be passed to the callback function
