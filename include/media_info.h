...
*                   Use the media_info_get_XXX() API before using the media_info_insert_to_db_with_data () API, get APIs can return MEDIA_CONTENT_ERROR_NO_DATA if no available data.
*
