...
* @see media_info_destroy()
*/
int media_info_create_handle(const char *path, media_info_h *media);

/**
* @brief Inserts media info to database with media info data.
* @since_tizen 3.0
*
* @remarks You must create media handle using media_info_create_handle(),
