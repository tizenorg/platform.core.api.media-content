 ...
 * @detalis You can set the played(opened) count of the media file.
 * @since_tizen 2.4
 *
 ...
 * @detalis You can set the latest played(opened) time of the media file.
 * @since_tizen 2.4
 *
 * @remarks It is NOT recommended to use this attribute for your application-specific purpose because this attribute can be overwritten by other applications (even 1900-01-01).
 *
 * @param [in] media The handle to media info
 * @param [in] played_time The played time of content
 *
 * @return 0 on success,
 *         otherwise a negative error value
 *
 ...
 * @detalis You can set the elapsed time for video(or audio) file.
 *                 If the file of other type(image or others), you can set the parameter to mark in the corresponding position
 * @since_tizen 2.4
 *
 * @remkars It is NOT recommended to use this attribute for your application-specific purpose because this attribute can be overwritten by other applications (even 0).
 *
 * @param [in] media The handle to media info
