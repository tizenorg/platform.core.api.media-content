 ...
 * @privilege %http://tizen.org/privilege/content.write
 *
 * @remarks If you want to destroy media handle before callback invoked, you must cancel face request by using media_info_cancel_face() \n
 ...
 * @details This function cancels the extraction request for given media item. \n
 *          If you cancel the extraction request before callback is invoked, the callback registered by media_info_extract_face() API will not be invoked.
 *
 * @since_tizen 3.0
 *
 * @privlevel public
 * @privilege %http://tizen.org/privilege/content.write
 *
 * @remarks If extraction is already done when you request the cancellation, this API return MEDIA_CONTENT_ERROR_INVALID_OPERATION
 *
 * @param[in] media The media info handle
 *
 * @return @c 0 on success,
