 ...
 * @retval #MEDIA_CONTENT_ERROR_PERMISSION_DENIED Permission denied
 */
int media_face_get_orientation(media_face_h face, int *orientation);
...
/**
 * @brief Sets the media id of the face handle.
 *
 * @since_tizen 3.0
 *
 * @param [in] face The face handle
 * @param [in] media_id The media id of the face handle
 *
 * @return 0 on success, otherwise a negative error value.
 * @retval #MEDIA_CONTENT_ERROR_NONE Successful
 * @retval #MEDIA_CONTENT_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 *
 */
int media_face_set_orientation(media_face_h face, int orientation);
