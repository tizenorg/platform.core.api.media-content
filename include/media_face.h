...
/**
 * @file media_face.h
 * @brief This file contains the media face API and related to all operations with the face information of the image in DB.\n
 *        Functions include cloning and destroying the face handler, getting face information such as tag, face id, face location, \n
 *        and updating face information to DB.
 */
