 ...
 * During media scanning, Media Service extract media nformation automatically. media information include basic file info like 
 ...
 * and Face detection is binding with feature http://tizen.org/feature/vision.face_recognition) \n
